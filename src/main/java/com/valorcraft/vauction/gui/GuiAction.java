...
record GuiAction(Type type, int number, long amount, UUID orderId, long deliveryId,
                 ItemStack item) {
    enum Type {
        HOME, SEARCH_HELP, PICKER, ORDERS, DELIVERIES, OPEN_MARKET, PAGE, REFRESH,
        BUY, SELL, ADJUST_QUANTITY, ADJUST_PRICE_PERCENT, BEST_PRICE,
        REVIEW, CONFIRM_ORDER, PREPARE_CANCEL, CONFIRM_CANCEL, CLAIM, BACK
    }
